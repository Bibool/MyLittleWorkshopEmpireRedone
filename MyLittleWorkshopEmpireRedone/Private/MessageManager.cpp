...
{
	printf( "  Tools:\n" );
	for (const Tool* inTool : g_GameManager->GetToolManager()->GetTools() )
		if (inTool->IsOwned())
...
void MessageManager::PrintShop() const
{
	printf( "  Shop content:\n" );
